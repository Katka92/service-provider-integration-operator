module redhat-appstudio/service-provider-integration-pact

go 1.20

replace github.com/redhat-appstudio/service-provider-integration-operator => ../
...
require (
	...
	github.com/codeready-toolchain/api v0.0.0-20230228003642-4e8ac01b3642 // indirect
